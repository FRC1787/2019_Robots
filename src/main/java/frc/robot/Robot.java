...
public class Robot extends TimedRobot {
    ...
    public void primusPeriodic() {
        ...
        // Climb direction switch with trigger and back button
        climbDirectionExtend = (leftJoyStick.getRawButtonPressed(CLIMB_DIRECTION_EXTEND_BTN_ID)) || !leftJoyStick.getRawButtonPressed(CLIMB_DIRECTION_RETRACT_BTN_ID);
